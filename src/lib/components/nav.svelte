...
<nav class="flex justify-start lg:justify-between items-start gap-4 lg:flex-row md:flex-row flex-col lg:items-center lg:w-5/6 w-11/12 mx-auto lg:mt-16 mt-8"  >
  ...
  <small class="text-[#daa520] font-semibold">Softwares</small>
  </div>
 
</div>
</a>

<ul class="flex lg:gap-8 gap-4">
  {#each links as link}
    <li class="text-white/70 font-sans uppercase text-sm font-semibold tracking-[2px]">
